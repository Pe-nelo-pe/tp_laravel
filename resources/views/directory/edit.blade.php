  ...
  <div class="container">
    <div class="row">
      <div class="col-12 text-center">
        <h1 class="display-1 text-white font-weight-bold font-primary">@lang('lang.title_edit_file')</h1>
      </div>
    </div>
  </div>
</section>
        ...
        <form action="" method="post">
          ...
          <div class="card-body">
            ...
            <div class="control-group col-12">
              ...
              <input type="text" id="name_fr" name="name_fr" class="form-control" value='{{ $directory->name_fr}}'>
            </div>
